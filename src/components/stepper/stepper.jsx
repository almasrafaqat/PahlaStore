...
import { ButtonContainer, Container, FlexContainer, FlexItems, OrderNote, OrderNoteButtonContainer, OrderNoteTable, OrderNoteWrapper, OrderNotes, Wrapper } from './stepper.style';
        ...
        <OrderNoteButtonContainer>
          ...
          <OrderNoteTable>
            ...
            <FlexContainer>
              ...
              <FlexItems><FormatPrice price="500" /></FlexItems>
            </FlexContainer>
            <FlexContainer>
              <FlexItems heading>Total Price </FlexItems>
              <FlexItems heading><FormatPrice price="2500" /></FlexItems>
            </FlexContainer>
            <Link to="/">
              <AddToCart
                content="center"
